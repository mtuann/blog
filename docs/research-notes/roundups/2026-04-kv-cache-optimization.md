...
- Paper: [Zeng et al. (2026), HybridKV: Hybrid KV Cache Compression for Efficient Multimodal Large Language Model Inference](https://arxiv.org/abs/2604.05887)
...
- Paper: [Hao et al. (2026), DeltaKV: Residual-Based KV Cache Compression via Long-Range Similarity](https://arxiv.org/abs/2602.08005)
...
- Paper: [Gao et al. (2025), Rethinking Key-Value Cache Compression Techniques for Large Language Model Serving](https://arxiv.org/abs/2503.24000)
...
- How these ideas interact with disaggregated serving systems such as [Qin et al. (2024), Mooncake](https://arxiv.org/abs/2407.00079) and [Zhong et al. (2024), DistServe](https://arxiv.org/abs/2401.09670).
