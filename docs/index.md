...
<div class="hero-shell home-hero">
<div class="hero-copy">
<p class="hero-eyebrow">Living Knowledge Base</p>
...
<span class="chip">Math + systems</span>
<span class="chip">Evergreen hubs</span>
<span class="chip">Research-note workflow</span>
</div>

<div class="hero-actions">
<a class="md-button md-button--primary" href="ml/">Start with Machine Learning</a>
...
-   :material-brain: **Machine Learning**
    ...
    Foundations, optimization, generalization, and practical experimentation.
    [Start Here](ml/index.md)

-   :material-creation: **Generative AI**

    Transformer foundations, LLMs, multimodal models, post-training, and agents.
    [Explore GenAI](genai/index.md)
...
-   :material-speedometer: **Efficient AI**
    ...
    Quantization, sparsity, efficient architectures, and inference optimization.
    [Explore Efficient AI](efficient-ai/index.md)

-   :material-shield-check: **Trustworthy AI**

    Interpretability, safety, robustness, evaluation, and reliability.
    [Explore Trustworthy AI](trustworthy-ai/index.md)

-   :material-notebook-edit-outline: **Research Notes**

    Paper reviews, monthly roundups, reading maps, and open questions.
    [Read Research Notes](research-notes/index.md)
...
<ul>
  <li>Evergreen hubs hold roadmaps, foundations, and durable abstractions.</li>
  <li>Research notes turn active reading into reviews, maps, and recurring updates.</li>
  <li>New posts should always connect back to the hub that gives them context.</li>
</ul>
</div>
